...
Background:
  ...
  @test @TestCase_3899 @ALM_VR_TC_38
  ...
  @test @TestCase_3904 @ALM_VR_TC_404
  ...
  @test @TestCase_3905 @ALM_VR_TC_405
  Scenario: Cancel medication assignation
   ...
   @test @TestCase_3903 @ALM_VR_TC_406
   Scenario:Add without available Hospitalization
